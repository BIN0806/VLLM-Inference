...
Do not stop, restart, or kill a loading vLLM process. Phase 4B accepted
KEDA 1→2→1 with one warm replica. Do not expose public ports, attempt
scale-to-zero, or install the HTTP interceptor until those gates are
approved.
